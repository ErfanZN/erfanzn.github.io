...
`dist/styles.css :root` owns tokens: background #080808, surface #111111, raised #191919, ink #f4f3ef, secondary #aaa9a6, border #303030, error #ffaaa4, focus #fff. Global scrollbar thumb #666, track #151515, hover #999, active #ccc. Display Bricolage, body DM, utility monospace. Content maximum 1280px. Pill buttons, 8px inputs, 16px project containers and 9px cover frames, 20px dialogs. Spacing in 4/8px increments with fluid section gutters. No light theme or toggle.
...
The work cards now have individual surface/border containment. Description height is natural, with 18–20px separation before outcomes. All six covers use the same HTML/CSS artboard frame and company/topic line; original Medium images are unmodified. Card actions are explicit bordered full-width buttons within the link, primary header contact is filled. Type tokens centralize body 16px, small 14px, label 12px, cards 30px desktop / 28px mobile and section headings with a shared fluid scale. Exceptions are documented compact cover metadata at 11px and hero footer context at 10px. Mobile identity is grouped immediately before the main headline below the portrait; mobile header contains only wordmark and Contact.
